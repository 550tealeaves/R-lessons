...
getwd()
list.files()
#If you get an error about the work directory, use Session > set working directory > Choose Directory
...
plot_gg(pop_size_final, scale = 400)  # higher number = more dramatic

#render as movie! 
render_movie("jp_pop_no_log.mp4")
