...
tiles <- get_tiles(bbox, provider = "Esri.WorldImagery", zoom = 9)
...
png("haiti_tiles.png", width = 9000, height = 9000, res = 800)
save_png(hillshade = overlay, filename = "haiti_tiles.png")
